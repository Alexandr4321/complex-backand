...
class GuestAutoPolicy
{
    ...
    public function edit(User $user, GuestAuto $template = null)
    {
        return  true;
    }
    public function create(User $user, GuestAuto $template = null)
    {
        return  true;
    }

    public function addPhotos(User $user, GuestAuto $model)
    {
