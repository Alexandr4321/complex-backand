...
namespace App\System\Models\Relations;
...
class BelongsToThrough extends Relation
{
     ...
     * @return void
     */
    public function __construct(Builder $query, Model $parent, array $throughParents, $prefix = '', array $foreignKeyLookup = [])
    {
